...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(t,e){t.exports=function(t,e,n,i){const s=t=>t&&"object"==typeof t&&"default"in t?t:{default:t},o=s(e),r=s(n),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},x={animation:!0,autohide:!0,delay:5e3};class E extends r.default{constructor(t,e){super(t,e),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return x}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const e=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),t.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(e,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const t=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(t,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(t,e){switch(t.type){case"mouseover":case"mouseout":this._hasMouseInteraction=e;break;case"focusin":case"focusout":this._hasKeyboardInteraction=e}if(e)return void this._clearTimeout();const n=t.relatedTarget;this._element===n||this._element.contains(n)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(t=>this._onInteraction(t,!0))),o.default.on(this._element,u,(t=>this._onInteraction(t,!1))),o.default.on(this._element,d,(t=>this._onInteraction(t,!0))),o.default.on(this._element,f,(t=>this._onInteraction(t,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(t){return this.each((function(){const e=E.getOrCreateInstance(this,t);if("string"==typeof t){if(void 0===e[t])throw new TypeError(`No method named "${t}"`);e[t](this)}}))}}return i.enableDismissTrigger(E),t.defineJQueryPlugin(E),E}(r(),c(),w(),A())}(Qe);var Ke,Xe,Ye,Ue=Qe.exports;Ke=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Xe=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Ye=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Ke||Xe||Ye)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var t,e=location.hash.substring(1);/^[A-z0-9_-]+$/.test(e)&&(t=document.getElementById(e))&&(/^(?:a|select|input|button|textarea)$/i.test(t.tagName)||(t.tabIndex=-1),t.focus())}),!1);const Je=document.getElementById("binaryCanvas"),Ge=Je.getContext("2d");var Ze,tn,en,nn=[],sn=[];function on(t,e){const[n,i]=t,[s,o]=e;return Math.max(Math.abs(n-s),Math.abs(i-o))}function rn(t,e){return Math.floor(Math.random()*(e-t+1))+t}function an(t,e){const n=t=>t.match(/\d+\.?\d*/g).map(Number),[i,s,o,r]=n(t),[a,l,c,u]=n(e);return`rgba(${rn(Math.min(i,a),Math.max(i,a))}, ${rn(Math.min(s,l),Math.max(s,l))}, ${rn(Math.min(o,c),Math.max(o,c))}, ${Math.random()*(Math.max(r,u)-Math.min(r,u))+Math.min(r,u)})`}function ln(t,e,n){const[i,s]=t;i<0||s<0||s>=nn.length||i>=nn[s].length?console.error("Invalid coordinates",{x:i,y:s}):(nn[s][i].color=e,nn[s][i].isBlob=n)}function cn(){if(nn.length>0){let t=0;for(;;){if(t++,t>1e3){console.log("Failed to find a position for creating a new blob. Exiting the loop to avoid crashing.");break}let e=[rn(0,nn[0].length-1),rn(0,nn.length-1)],n=!1;for(let t=0;t<nn.length;t++){for(let i=0;i<nn[t].length;i++){const s=nn[t][i];if(s.isBlob&&on(e,s.getCords())<5){n=!0;break}}if(n)break}if(!n)return{lifeSpan:0,BlobCords:[e]}}}}function un(){en&&clearInterval(en),Je.width=window.innerWidth,Je.height=window.innerHeight,Ze=function(){let t=document.createElement("div");t.style.width="1em",t.style.height="1em",document.body.appendChild(t);const e=t.offsetWidth;return document.body.removeChild(t),e}(),tn=1.5*Ze;const t=Math.ceil(Je.width/tn),e=Math.ceil(Je.height/tn);if(isNaN(t)||isNaN(e)||t<0||e<0)console.error("Invalid dimensions calculation",{columns:t,rows:e,width:Je.width,height:Je.height,fontSize:tn});else{if(nn=Array.from({length:e},((e,n)=>Array.from({length:t},((t,e)=>({value:"10".charAt(rn(0,"10".length-1)),color:an("rgba(0, 173, 72, 1)","rgba(10, 210, 87, 1)"),isBlob:!1,getCords:function(){return[e,n]}}))))),0==sn.length){console.log("making intital blobs");for(let t=0;t<30;t++)sn.push(cn())}else console.log("not making blobs: "+sn.length);en=setInterval(dn,200)}}function dn(){!function(){for(let t=0;t<sn.length;t++){sn[t].lifeSpan++;let e=!1;rn(0,1e4)<=sn[t].lifeSpan&&(e=!0);let n,i,s=0,o=0;for(let e=0;e<sn[t].BlobCords.length;e++)sn[t].BlobCords[e][0]>s&&(s=sn[t].BlobCords[e][0],n=e),sn[t].BlobCords[e][1]>o&&(o=sn[t].BlobCords[e][1],i=e);if(0===rn(0,1)){let e;if(rn(0,100)<70){let r=rn(0,1)?"x":"y",a=rn(0,1)?-1:1;e="x"===r?[s+a,sn[t].BlobCords[n][1]]:[sn[t].BlobCords[i][0],o+a]}else{let n=rn(0,sn[t].BlobCords.length-1),i=rn(0,1)?-1:1,s=rn(0,1)?-1:1;e=[sn[t].BlobCords[n][0]+i,sn[t].BlobCords[n][1]+s]}e[0]>=0&&e[1]>=0&&e[1]<nn.length&&e[0]<nn[0].length&&sn[t].BlobCords.push(e)}for(let n=0;n<sn[t].BlobCords.length;n++)e?ln(sn[t].BlobCords[n],an("rgba(0, 173, 72, 1)","rgba(10, 210, 87, 1)"),!1):ln(sn[t].BlobCords[n],an("rgba(29, 234, 94, 1)","rgba(123, 234, 234, 1)"),!0);e&&(sn[t]=cn())}}(),Ge.fillStyle="rgba(0, 0, 0, 1)",Ge.fillRect(0,0,Je.width,Je.height),Ge.font=tn+"px Georgia",Ge.textBaseline="top",Ge.imageSmoothingEnabled=!1;for(let e=0;e<nn.length;e++)for(let n=0;n<nn[e].length;n++){var t=nn[e][n];Ge.fillStyle=t.color,Ge.fillText(t.value,n*tn,e*tn)}}window.addEventListener("resize",un),un(),t.Alert=T,t.Button=k,t.Carousel=I,t.Collapse=N,t.Dropdown=ve,t.Modal=Le,t.Offcanvas=$e,t.Popover=Re,t.Scrollspy=ze,t.Tab=Ve,t.Toast=Ue,t.Tooltip=He}));
